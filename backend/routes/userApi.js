...
bcrypt.hash(req.body.password, 10, function(err, hash) {
 let data={firstName:req.body.firstName,lastName:req.body.lastName,emailId:req.body.emailId,
...
let data={firstName:req.body.firstName,lastName:req.body.lastName,emailId:req.body.emailId,
phoneNo:req.body.phoneNo,city:req.body.city,gender:req.body.gender,dob:req.body.dob}
...
async function sendmail(data,cb) {
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "rajankaushal2004@gmail.com", // generated ethereal user
      pass: "rchhtvwvabrinltk", // generated ethereal password
    },
  });

  // send mail with defined transport object
  let info = await transporter.sendMail({
    from: '"Magnews " <rajankaushal2004@gmail.com>', // sender address
    to: data.emailId, // list of receivers
    subject: "Welcome to Amazon ✔", // Subject line
  
    html: `<h2>Dear ${data.firstName} ${data.lastName} </h2><p>Your shopping-site account has been created successfully</p><p>Enjoy purchasing new product </p> <h3>Regards Magnews</h3>` // html body
  });
 cb(info)
